...
static const device_config_t win471_config[] = {
    // clang-format off
    {
        .name           = "bios",
        .description    = "BIOS Version",
        .type           = CONFIG_BIOS,
        .default_string = "win471",
        .default_int    = 0,
        .file_filter    = NULL,
        .spinner        = { 0 },
        .selection      = { { 0 } },
        .bios           = {
            {
                ...
                .local         = 0,
                .size          = 65536,
                .files         = { "roms/machines/win471/486-SiS_AC0360136.BIN", "" }
            },
            {
                .name          = "Award Modular BIOS v4.50G",
                .internal_name = "win471_450g",
                .bios_type     = BIOS_NORMAL,
                .files_no      = 1,
                .local         = 0,
                .size          = 65536,
                .files         = { "roms/machines/win471/ah4-02.bin", "" }
            },
            { .files_no = 0 }
        }
    },
